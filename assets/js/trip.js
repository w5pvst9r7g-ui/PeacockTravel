...
(function () {
  ...
  var ICONS = {
    ...
    moon: 'M16.6 12.2A8.6 8.6 0 0 1 9.4 3.7a8.7 8.7 0 0 1 .2-1.5A10 10 0 1 0 21.8 14a8.6 8.6 0 0 1-5.2-1.8z'
  };
  function icon(name) {
    var d = ICONS[name];
    if (!d) return '';
  ...
  groups.forEach(function (g) {
    ...
    items.forEach(function (f) {
      ...
      if (f.kid) li.setAttribute('data-kid', '');
      var r = f.rating;
  ...
  if (eatPhoto && R.eatPhoto) {
    ...
    eatPhoto.addEventListener('load', function () {
      ...
      if (cred) cred.textContent = R.eatPhoto.credit;
    });
    eatPhoto.src = R.eatPhoto.src;
  }
